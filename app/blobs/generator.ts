...
*/
export function generateBlob(parameters: BlobParameters = {}): BlobResult {
    const params = {
        seed: null,
    ...
    const { path: svgPath, seedValue: seed } = blobshape({ ...params, size: fixedSize });
    return { parameters: { ...params, seed }, svgPath };
}
